    ...
    <section id="cases" className="py-24 bg-white">
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {[
            { ind: "Retail & FMCG", title: "SKU Demand Forecasting", desc: "GBR + SARIMA ensemble with automated weekly retraining and drift alerts. Deployed as a REST microservice in 8 weeks.", bg: "from-blue/10 to-blue/5" },
            { ind: "Financial Services", title: "Real-time Fraud Detection", desc: "XGBoost + Isolation Forest scoring every transaction at sub-12ms latency with SHAP explanations for compliance.", bg: "from-rose-500/10 to-rose-500/5" },
            { ind: "Healthcare", title: "Clinical NLP Automation", desc: "Fine-tuned BERT for ICD-10 code extraction from unstructured clinical notes. Eliminated the manual coding backlog.", bg: "from-teal/10 to-teal/5" }
          ].map((c, i) => (
          ...
          <div className="bg-navy rounded-3xl p-10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { v: "3 Clients", l: "100% delivered on time" },
                  { v: "8-Week", l: "From data to production" },
                  { v: "Production-grade", l: "MLOps from day one" },
                  { v: "Zero", l: "Failed deployments" }
                ].map((s, i) => (
